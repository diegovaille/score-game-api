...
public class ScoreController {
    ...
    public ResponseEntity<UserPositionDTO> getUserPosition(@PathVariable @NotNull Integer userId) {
        ...
        return userPositionDTO.isPresent() ? new ResponseEntity<>(userPositionDTO.get(), HttpStatus.OK) :
             new ResponseEntity<>(new EmptyUserPositionDTO(), HttpStatus.OK);
    }
